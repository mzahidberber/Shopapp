    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "2c5e174e-3b0e-446f-86af-483d56fd7210", null, "Admin", "ADMİN" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 1, "Desktop Computer", "desktoppc" },
                    { 3, 1, "Game Computer", "desktop-game-pc" },
                    { 4, 2, "Mobile Phone", "mobilephone" },
                    { 5, 2, "Push Button Phone", "pushbuttonphone" },
                    { 6, 2, "Tablet", "tablet" },
                    { 7, 3, "Television", "television" },
                    { 8, 3, "Projection", "projection" },
                    { 9, 3, "SoundBar", "soundbar" },
                    { 10, 4, "Camera", "ccamera" },
                    { 11, 4, "Video Camera", "videocamera" },
                    { 12, 4, "Drone", "drone" },
                    { 13, 5, "Earphones", "earphones" },
                    { 14, 5, "Phone case", "phonecase" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                {
                    { 1, 1, "Laptop", "laptop" },
                    { 2, 1, "Game Notebook", "gamenotebook" },
                    { 3, 2, "Desktop", "desktop" },
                    { 4, 2, "Game Computer", "game-pc" },
                    { 5, 3, "Computer", "c-game-pc" },
                    { 6, 4, "Smarth Phone", "smarthphone" },
                    { 7, 4, "Phone", "m-phone" },
                    { 8, 5, "Phone", "p-phone" },
                    { 9, 6, "Tablet", "tablet" },
                    { 10, 7, "Full HD", "fullhd" },
                    { 11, 8, "Projection", "p-projection" },
                    { 12, 9, "SoundBar", "s-soundbar" },
                    { 13, 10, "Camera", "c-camera" },
                    { 14, 10, "Vlog Camera", "vlogcamera" },
                    { 15, 11, "Camera", "v-camera" },
                    { 16, 12, "Drone", "drone" },
                    { 17, 13, "Bluetooth Earphones", "bluetoothearphones" },
                    { 18, 13, "Microphone", "Microphone" },
                    { 19, 14, "Case", "case" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 8, "MSI", 4, "msi" },
                    { 9, "Dell", 5, "dell" },
                    { 10, "Samsung", 5, "samsung" },
                    { 11, "Samsung", 6, "samsung" },
                    { 12, "Apple", 6, "apple" },
                    { 13, "Samsung", 7, "samsung" },
                    { 14, "Apple", 7, "apple" },
                    { 15, "Samsung", 8, "samsung" },
                    { 16, "Apple", 8, "apple" },
                    { 17, "Apple", 9, "apple" },
                    { 18, "Lenova", 9, "lenova" },
                    { 19, "Vestel", 10, "vestel" },
                    { 20, "Samsung", 10, "samsung" },
                    { 21, "Vestel", 11, "vestel" },
                    { 22, "Samsung", 11, "samsung" },
                    { 23, "Vestel", 12, "vestel" },
                    { 24, "Samsung", 12, "samsung" },
                    { 25, "Canon", 13, "canon" },
                    { 26, "Nikon", 13, "nikon" },
                    { 27, "Canon", 14, "canon" },
                    { 28, "Nikon", 14, "nikon" },
                    ...
                    { 30, "Nikon", 15, "nikon" },
                    { 31, "Autel", 16, "autel" },
                    { 32, "Samsung", 17, "samsung" },
                    { 33, "Samsung", 18, "samsung" },
                    { 34, "Apple", 19, "apple" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "BrandId", "CategoryId", "Description", "HomeImageUrl", "IsApprove", "IsHome", "MainCategoryId", "Name", "OrderId", "Price", "Stock", "SubCategoryId", "Url" },
                values: new object[,]
                {
                    { 1, 1, 1, "Güzel laptop", "lenovaimg1.jpg", true, true, 1, "Dell Laptop", null, 10.0, 10, 1, "dell-laptop" },
                    { 2, 17, 6, "Güzel tablet", "lenovatablet1.jpg", true, true, 2, "Lenova Tablet", null, 101.0, 11, 9, "lenova-tablet" }
                });
