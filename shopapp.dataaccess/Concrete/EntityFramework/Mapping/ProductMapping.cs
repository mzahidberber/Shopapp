...
internal class ProductMapping : IEntityTypeConfiguration<Product>
{
    public void Configure(EntityTypeBuilder<Product> builder)
    {
		...
		builder.HasData(
            ...
            new Product { Id = 2, Name = "Lenova Tablet", Url = "lenova-tablet", MainCategoryId = 2, CategoryId = 6, SubCategoryId = 9, BrandId = 17,Stock=11, Price = 101, Description = "Güzel tablet", HomeImageUrl = "lenovatablet1.jpg", IsApprove = true, IsHome = true }
            );
    }
}
